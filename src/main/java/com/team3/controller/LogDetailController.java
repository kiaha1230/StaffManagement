...
public class LogDetailController {
	...
	@GetMapping("getByLogAuditId/{id}")
	public ArrayList<LogDetail> getByLogAuditId(@PathVariable Integer id) {
		return (ArrayList<LogDetail>) logDetailService.getByLogAuditId(id);
	}
